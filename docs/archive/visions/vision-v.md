...
flowchart TD
    ...
    subgraph StagedProgression ["Operational & Topological Staged Progression"]
        direction TB
        P_Minus1["🎯 Phase −1: Foundational Proof<br/><i>(Isolated Micro-Core Substrate)</i><br/>• Local credit assignment<br/>• O(1) memory<br/>• Bounded settling on raw bytes"]:::primary
